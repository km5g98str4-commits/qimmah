...
| `endpoint-missing` | **٢٣** — المصدر موجود والمسار ينتظر تطبيق الهجرة |
| `source-system-missing` | **٤** — لا جدول ولا سجلّ أصلًا |
...
1. **§10 (الخلاصة الصادقة)** — الأعداد الأربعة صارت ٤ / ٢٣ / ٤ / ٨ والمجموع ٣٩
   (كانت ٤ / ١٦ / ٧ / ٨ ومجموعها ٣٥).
