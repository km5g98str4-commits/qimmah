...
| Food package on `c/phase-ii-food-production-002@4a4380654ed08fa73124a262411c056d12aa8049` | `CURRENT-PHASE-II / QUARANTINED_SEED` | Canonical contract, source ledger, deterministic 55-row package, five checksummed artifacts, and 25/25 adversarial checks; not distributable or runtime-integrated. |
| Exercise package on `h/phase-ii-exercise-production-002@e97522f3e68d9022aa7bd6c3203da5b2a2f41355` | `CURRENT-PHASE-II / REVIEW_REQUIRED` | Deterministic 181-ID ledger, blocked image queue, media rollback contract, and ten-ID video research pilot with zero approved candidates. |
