...
**الفرع:** `codex/qimmah-exercise-production-001` · **الأساس التاريخي:** `1bcf7a9` = `[PKG-7][green]`
**الأساس الحالي: `d83add2`** — رأس Web Sovereign النهائي (تصالحت الحارة معه في `ed224c3`).
