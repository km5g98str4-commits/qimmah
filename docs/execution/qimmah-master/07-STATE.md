...
- القرار: **٣١٨ مرقّى** (كلٌّ بـfdcId ووصف USDA وقيم ١٠٠غ، الحصّة من foodPortions أو ١٠٠غ معلنة)
  · **٧٠ مغطًّى** بصنف يدوي قائم (نُقلت إليه كلمات البحث) · **١٨ مربوط** بأطباق سعودية قائمة
  · **١٨٠ وصفة/مركّب** (كبسة · مناقيش · ساندويتشات · سلطات — لا قيمة عالمية مزيّفة)
  · **١٤ محجور** بسبب مسمّى (لحم غنم · فريكة · نودلز سريعة · مخلل مشكّل…).
  `data/food-production/generic/resolution.json` يحمل الحكم لكل صفّ.
- البسمتي/الياسمين: سجلّ USDA للفئة (أرز أبيض طويل الحبّة) بملاحظة صريحة في الخريطة.
...
- الإثبات: `test:generic-foods` (٤٩ فحصًا · ٣٦ استعلامًا للمؤسس · محاكاتا التفاف) في البوابة؛
  `food-coverage` ١٧٤ · `food-meal-search` ٤٤ · `food-db` ٢٧ · `saudi-foods` خضراء.
  الكتالوج المنسَّق: ٦٤٧ ⇒ **٩٦٥** صنفًا.
...
### COPY-DENSITY-001 (الدفعة الأولى) · ZOOM
- نصوص «اليوم الأول» والإعداد وكود التفعيل قُصّت إلى النصف تقريبًا بالعربية والإنجليزية؛ القانوني والصحّي لم يُمسّ.
