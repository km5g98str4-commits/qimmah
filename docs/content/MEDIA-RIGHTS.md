...
| قِمّة — بطاقات حركة داخلية (IN-HOUSE) | 57 | `public/exercise-cards/{slug}.jpg` — سجلّ الاستلام في `assets/exercise-cards-intake/` | مادة سلّمها المؤسس، وأكّد (٢٠٢٦-٠٩-٠٦) أنها **مولَّدة/مُكلَّفة له ولا يملكها طرف ثالث**؛ لا علامة مائية ولا مصدر خارجي | `IN-HOUSE` | نملك الحقوق؛ إسناد اختياري |
...
## ملحق [CARDS-INTAKE] — بطاقات الحركة الداخلية (٢٠٢٦-٠٩-٠٦)

**ما دخل:** ٥٧ بطاقة حركة من مادة المؤسس «قائمة_التمارين_المصورة.docx» (٦٣ صفًّا).
كل بطاقة لوح واحد يحمل إطارَي البداية والنهاية للحركة مع تظليل العضلة المستهدفة.

**كيف صار الحكم `IN-HOUSE`:** عند الاستلام لم تكن المادة تنطبق على أيٍّ من الحكمين
(لا منبع ولا رخصة ⇒ ليست `CLEARLY-LICENSED`، وليست ناتج مولّد داخلي ⇒ ليست
`IN-HOUSE` بالاشتقاق)، فحكمها كان `UNRESOLVED` ومعناه **لا تُشحن**. لم يُختم حكم
بلا دليل: رُفع سؤال الأصل للمؤسس، وجوابه — **مولَّدة/مُكلَّفة لي، لا يملكها طرف
ثالث** — هو سند الحكم.

> **حدّ صادق:** سند هذه الصفوف **تأكيد المؤسس على أصل الرسوم**، لا تحقّق شبكي كالـ٢٥٠
> لقطة أعلاه (لا منبع خارجيًّا يُقارَن به). يبقى هذا تدقيقًا هندسيًّا لا رأيًا قانونيًّا.

**ما لم يدخل — ٦ صفوف، وكلٌّ بسببه:**

| الصفّ | التمرين | السبب |
| --- | --- | --- |
| ٦ · ١٢ · ٣٠ · ٤٣ | غطس مساعد · تجديف تي-بار · سكوات بار · مرجحة كيبل | الهدف يحمل **لقطة مرخّصة** من `free-exercise-db`؛ البطاقة لا تُزيح أصلًا نظيف الحقوق |
| ٣٦ | مد ورك واقف | **إطاران لتمرينين مختلفين** — الثاني مقعد فرط استطالة لا مدّ ورك واقف |
| ٥٩ | بيربي | **حركة خاطئة** — الصورة واقفٌ بجانب جهاز كيبل، لا بيربي |

**ملاحظة على المادة:** وصلت كل بطاقة بشريط عنوان **محروق في الصورة** بالعربية
والإنجليزية. قُصَّ الشريط قبل الوصل: يكرّر اسمًا يرسمه التطبيق بنفسه، **ولا يتبدّل
بلغة المستخدم** (خرق §6)، وفي عدّة بطاقات كان **عربية مشوّهة** («الباينة» بدل
البايسبس · «جرفول»). الأصل غير المقصوص محفوظ كاملًا في
`assets/exercise-cards-intake/original/` بـSHA-256 لكل ملف.

**أثر جانبي مقصود:** كتابة نَسَب المخطّط والبطاقة صراحةً في مولّد مانيفست الإنتاج
أسقطت `UI_PROVENANCE_NULL_ALLOWLIST` من ٢٥ إلى **٠** — الدَّين الذي كانت تشير إليه
`media-provenance-proof.ts` مسدَّد.
