...
## ملحق ٢٠٢٦-٠٩-٠٨ — بطاقات المؤسس [FOUNDER-CARDS-001]

٦٣ بطاقة تمرين أنتجها المؤسس بنفسه (تصيير ثلاثي الأبعاد مع تظليل العضلة وعنوان
عربي/إنجليزي) دخلت المستودع في `public/exercise-cards/` بحكم **`IN-HOUSE`** ومصدر
`qimmah-founder-card`. التعيين والبصمات في
[`exercise-cards/INTAKE-2026-09-08.md`](./exercise-cards/INTAKE-2026-09-08.md).
سجلّ الحقوق صار **٣٦٠ صفًّا** (٢٣٤ `CLEARLY-LICENSED` + ١٢٦ `IN-HOUSE`)، ولا `UNKNOWN`
ولا `RESTRICTED`. البطاقة تسبق كل الطبقات في مانيفست الإنتاج؛ الرسوم القديمة تبقى
بديلًا صادقًا عند تعذّر التحميل.
