...
**الحد الأدنى للعمر:** **١٢ سنة.** رقم نهائي بتوقيع المؤسس (AGE 12 SUCCESSOR RC — ناقض [CTO-14]). يُقرأ من `AGE_RANGE` وحده.
...
**الحد الأدنى للعمر:** **١٢ سنة** — نهائي بتوقيع المؤسس (AGE 12 SUCCESSOR RC — ناقض [CTO-14]). انظر «ه-١».
...
> ⚠️ **نُقض هذا البند بقرار مؤسس لاحق — FOUNDER AUTHORIZATION · AGE 12 SUCCESSOR RC.**
> الحدّ المعتمد الآن **١٢** لا ١٣، ومصدره الوحيد `AGE_RANGE` في
> `src/config/profileDomain.ts`. ما دون هذا السطر **سجلّ تاريخي** يُقرأ لمعرفة
> كيف نشأ التناقض، لا ليُنفَّذ. وحدّ الأمان دون ١٨ **لم يتحرّك** (`ADULT_MIN_AGE`).
