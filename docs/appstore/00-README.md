# App Store Connect listing pack — Qimmah / قِمّة

Complete, code-grounded listing pack for the App Store submission of the Capacitor iOS app.
Every feature claim traces to a file; every Apple limit is verified and dated (2026-07-13).
Nothing here is applied to App Store Connect — submission is the owner's step (`06-submission-runbook.md`).
...
**Grounding sources:** code in `src/**` (feature trace), the legal pack on `origin/legal/appstore-pack`
(`docs/legal/app-privacy-labels.md`, `privacy-policy.md`, `terms-of-service.md`), the v2.1 design PDF
(§01 welcome copy, §02 tone), `docs/APP-READINESS.md`, and `docs/ios-setup.md`.

**Recommendation in one line:** ship as name **«قِمّة: تمارين وتغذية وتقدّم»** + subtitle
**«درّب بوضوح. تقدّم بثقة.»**, Arabic primary, Health & Fitness, one 6.9″ AR screenshot set.
