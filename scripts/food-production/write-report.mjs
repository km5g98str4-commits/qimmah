...
### الذيل العالمي مرتّب بالشعبية لا بالاكتمال

هذه قاعدة **ماسح باركود**، فقيمتها أن تجد ما يمسحه الناس فعلًا. الترتيب بدرجة اكتمال
الحقول وحدها كان يُدخل سجلات مكتملة لا يمسحها أحد **ويُخرج كوكاكولا ونوتيلا** — وهو ما
تحقّقتُ منه ببحث فعلي في الشرائح المُنتَجة قبل التصحيح. فصار ترتيب الذيل العالمي على
\`unique_scans_n\` (عدّاد مسح حقيقي من OFF) ثم الثقة. السعودية والخليج خارج هذا الترتيب
أصلًا لأنهما **بلا سقف**.
