// يُشغّل إثبات محرّك التخصيص (TS بمسارات @/) عبر esbuild فوق localStorage
// مُحاكى، بلا متصفح. نفس نمط run-onboarding-intent-proof.mjs.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/personalization-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'personalization-'))
