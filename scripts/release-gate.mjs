...
//   ٤) مصفوفة الإصدار: الشخصيات الثماني + الساكنة + WebKit — كانت خارج كل بوّابة
//
...
const STAGES = [
  ...
  {
    // ── [SOVEREIGN-003] مصفوفة الشخصيات داخل بوّابة الإصدار، لا خارجها ──────
    //
    // هذه هي الفجوة البنيوية التي شحن المشروع بسببها عيوبًا متكرّرة: أطقم
    // المتصفّح الحاسمة (الشخصيات الثماني · المصفوفة الاستجابية · فحوص الحزمة
    // الساكنة · سجلّ الارتدادات · وحصّة WebKit) كانت تعيش **خارج** البوّابة
    // وخارج CI معًا، فتُشغَّل حين يتذكّرها أحد. وكلّ عيب التقطتْه لاحقًا كان
    // قابلًا للالتقاط قبل الدفع.
    //
    // تُشغَّل هنا **بمحرّكيها** (Chromium + WebKit): آخر عطلين في هذه الموجة
    // ظهر أحدهما على WebKit وحده، والآخر على الاثنين — ومحرّك واحد كان
    // ليُخفي أوّلهما تمامًا.
    group: 'مصفوفة الإصدار (شخصيات + محرّكان)',
    browser: true,
    steps: [
      { name: 'release convergence (chromium + webkit)', cmd: ['node', 'scripts/release/run-release-convergence.mjs'] },
    ],
  },
]
