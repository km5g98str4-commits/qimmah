...
const SETUP = {
  machine: ['اضبط ارتفاع المقعد والمسند بحيث يمرّ المفصل بمحور الجهاز، واستقرّ بظهر مسنود وقدمين ثابتتين.', 'أول شي اضبط الجهاز على مقاسك: ارتفاع المقعد والمقبض، ثم استقرّ بثبات قبل أول تكرار.'],
  smith: ['حرّر البار من الحامل بلفّة بسيطة، وضع قدميك في المكان اللي يوازن الحركة على مسار البار.', 'تموضع تحت بار السميث بحيث يمرّ المسار على خطّ الحركة الطبيعي، ثم ثبّت قبضتك.'],
