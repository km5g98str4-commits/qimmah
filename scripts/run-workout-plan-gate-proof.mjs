// يُشغّل إثبات ح-١ (استعادة الجلسة بعد قتل التطبيق) — TS بمسارات @/ عبر esbuild
// فوق localStorage مُشيَّم، بلا متصفح.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/workout-plan-gate-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'workout-plan-gate-'))
