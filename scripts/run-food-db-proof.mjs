...
const checks = [
  ...
  ['أصناف سلاسل «مطاعم» منسَّقة = 105', r.restaurants === 105, `restaurants=${r.restaurants}`],
  ...
  ['كل أصناف السلاسل معلّمة «تقديري»', r.restaurantsEstimated === 105, `estimated=${r.restaurantsEstimated}`],
