...
const result = await build({
  entryPoints: [resolve(root, 'scripts/canonical-stores-proof.ts')], bundle: true, format: 'esm', platform: 'node', write: false,
...
const file = join(mkdtempSync(join(tmpdir(), 'canonical-')), 'proof.mjs')
