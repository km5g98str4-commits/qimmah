 ...
 *
 * [FINAL-CONVERGENCE] الحاويات تحمل Chromium بنسخة بناء تخالف ما تطلبه حزمة
 * playwright، فيفشل الإطلاق ولو كان في الجهاز متصفّح صالح. و`e2e/lib/engine.mjs`
 * يعالجها بـ`PW_CHROMIUM`، لكنّ هذا المشغّل يختار محرّكه بالاسم فلا يمرّ بتلك
 * الوحدة. ولا بدّ أن يقرأ **الفحص** العلَم كما يقرأه **التشغيل**: فحصٌ يطلق بلا
 * العلَم يحكم «المحرّك غير متاح» ثم يرفض المشغّل إصدار حكم — رفضٌ صحيح بسبب خاطئ.
 */
