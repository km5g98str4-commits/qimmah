// يحزم إثبات سجلّ التغذية المؤرَّخ (TS بمسارات @/) عبر esbuild فوق localStorage
// مُحاكى ويشغّله (بلا متصفح) — نمط run-data-safety-proof.mjs نفسه.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/nutrition-history-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'nutrition-history-'))
