// يحزم إثبات سلطة مدّة الجلسة ([SOVEREIGN-PLAN-004]) عبر esbuild فوق كعب متصفّح
// **كامل** ويشغّله بلا متصفح.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/session-duration-authority-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'session-duration-'))
