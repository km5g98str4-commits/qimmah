...
//   وكان ينشر حدًّا أدنى للعمر يخالف مدقّق التطبيق نفسه.
...
const FORBIDDEN = [
  ...
  {
    id: 'ح-٣ · حدّ أدنى للعمر متراجع إلى ١٣',
    patterns: [/13\s+or\s+older/iu, /الحد\s+الأدنى[^.]{0,50}١٣\s+سنة/u, /\b13\+\s+eligibility/iu],
    why: 'الحدّ الأدنى المدعوم ١٢ سنة بقرار المؤسس. حدّ 18 مستقلّ ويبقى حاكمًا للوصفة الرقمية للبالغين.',
  },
  {
