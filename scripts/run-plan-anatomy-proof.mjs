// يحزم إثبات تشريح يوم الدفع/السحب ([SOVEREIGN-PLAN-002]) عبر esbuild ويشغّله
// فوق كعب متصفّح **كامل** (نمط run-workout-calendar-proof.mjs) — بلا متصفّح.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/plan-anatomy-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'plan-anatomy-'))
