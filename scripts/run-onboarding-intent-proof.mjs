// يُشغّل إثبات موجة «النية والمستوى» (TS بمسارات @/) عبر esbuild فوق
// localStorage مُحاكى، بلا متصفح. نفس نمط run-body-fields-proof.mjs.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/onboarding-intent-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'onboarding-intent-'))
