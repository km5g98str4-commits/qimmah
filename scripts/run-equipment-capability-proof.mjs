// يحزم إثبات سلامة الإصابات [SOVEREIGN-PLAN-001] عبر esbuild فوق localStorage
// مُحاكى ويشغّله (بلا متصفح) — نفس نمط run-plan-builder-proof.mjs.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/equipment-capability-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'equipment-capability-'))
