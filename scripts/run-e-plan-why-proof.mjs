// يشغّل إثبات «لماذا هذه خطتك؟» (حارة E) عبر esbuild وreact-dom/server — بلا متصفح.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/e-plan-why-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  jsx: 'automatic',
...
const dir = mkdtempSync(join(tmpdir(), 'e-plan-why-'))
