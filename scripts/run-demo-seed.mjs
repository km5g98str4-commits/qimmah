// ⚙️ أداة تطوير فقط — تُخرج لقطة متصفّح لبذر بيانات تجريبية محلّية.
// لا تعمل إلا عند استدعائها صراحةً. لا تمسّ Supabase ولا الشبكة.
//
//   node scripts/run-demo-seed.mjs --profile=reviewer   # يطبع اللقطة (انسخها للـ Web Inspector)
//   node scripts/run-demo-seed.mjs --profile=veteran --out=demo.js   # يكتبها لملف أيضًا
//   node scripts/run-demo-seed.mjs --profile=fresh --owner=<uid>      # مفتاح مربوط بالحساب
