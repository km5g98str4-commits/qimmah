// يُجمّع إثبات نظام القوة (TS بمسارات @/) عبر esbuild فوق localStorage مُحاكى
// ويشغّله (بلا متصفح). لا يمسّ package.json.
//   node scripts/run-strength-proof.mjs
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/strength-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'strength-'))
