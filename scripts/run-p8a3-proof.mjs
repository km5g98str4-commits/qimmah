// يُجمّع إثبات P8 A3 (إضافة منتج يدويًا + OCR، TS بمسارات @/) عبر esbuild فوق localStorage
// مُحاكى ويشغّله.
...
const result = await build({
  entryPoints: [resolve(root, 'scripts/p8-a3-proof.ts')],
  bundle: true,
  format: 'esm',
  platform: 'node',
  write: false,
...
const dir = mkdtempSync(join(tmpdir(), 'p8-a3-'))
