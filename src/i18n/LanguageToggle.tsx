  ...
  if (variant === 'compact') {
    ...
    return (
      <button
        ...
        title={nextLabel}
        className={cn(
          'inline-flex items-center gap-1 rounded-lg border border-line bg-surface px-2 py-1 text-[11px] font-black text-ink-700 transition-colors hover:text-ink-900',
          className,
        )}
      >
