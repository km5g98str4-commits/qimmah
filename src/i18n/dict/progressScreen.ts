...
const ar: ProgressScreenStrings = {
  ...
  goalPrefix: 'الهدف',
  ofGoalPrefix: 'من',
  goalReached: '🎉 وصلت هدفك اليوم — أحسنت!',
  ...
  notLoggedYet: 'لم تُسجّل بعد',
  selectedNotLoggedSuffix: 'لم تُسجّل بعد — جرّب تضيفها',
  ...
  sectionEmptyBody: 'كل مجموعة تسجّلها تنعكس مباشرة على تغطية عضلاتك.',

  privacyNote: 'قياساتك وملاحظاتك محفوظة على جهازك فقط ولا يتم رفعها أو إرسالها لأي خادم.',
}
