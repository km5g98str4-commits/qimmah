...
const ar: OnboardingStrings = {
  ...
  sexTitle: 'جنسك؟',
  sexHint: 'نستخدمه لحساب السعرات بدقة.',
  ageTitle: 'كم عمرك؟',
  ageUnit: 'سنة',
  ...
  targetWeightTitle: 'وش وزنك الهدف؟',
  ...
  splitModeHint: 'التلقائي يكفي معظم الناس.',
  ...
  nutritionStyleHint: 'نقدر نعدّلها لاحقًا.',
  mealsTitle: 'كم وجبة باليوم تناسبك؟',
  mealsHint: 'نوزّع سعراتك عليها.',
  mealsUnit: 'وجبات',
  mealDistributionTitle: 'تفضّل وجباتك أكبر وأقل، ولا أصغر وأكثر؟',
  mealDistributionHint: 'يحدّد أين نركّز سعراتك.',
  appetiteTimingTitle: 'متى تكون أكثر جوعًا؟',
  ...
  foodAllergiesLabel: 'حساسيات غذائية (اختر ما ينطبق)',
  ...
  stepPrefix: 'الخطوة',
  stepOf: 'من',
  completeRequiredFirst: 'أكمل الخطوات المطلوبة أولًا',
  ...
  welcomePoint1: 'تقدر تعدل كل شيء لاحقًا',
  welcomePoint2: 'لا تحتاج معرفة تقنية',
  welcomePoint3: 'كل شيء محفوظ على جهازك',
  welcomeHelloNamed: 'أهلاً',
  welcomeHelloGuest: 'أهلاً بك في قِمّة 👋',
  welcomeDescription:
    'بنجهّز تطبيقك الشخصي خطوة بخطوة. بس جاوب على أسئلة بسيطة، وتقدر ترجع تعدّل أي شي وقت ما تبي.',
  welcomeNameLabel: 'اسمك',
  welcomeNameHint: 'يظهر في صفحتك وفي ترحيب «اليوم» — مطلوب للبدء',
  welcomeNamePlaceholder: 'مثال: محمد',
  welcomeNameRequired: 'اكتب اسمك للمتابعة.',
  welcomeFirstTime: 'سنجهّز صفحتك لأول مرة. تقدر تعدل كل شيء لاحقًا.',
  welcomeLivePreviewNote: 'كل ما تكمل خطوة، تشوف معاينة صفحتك تتحدّث على طول. جاهز؟ اضغط «التالي» نبدأ.',

  bodyTitle: 'بياناتك',
  bodyDescription: 'جاوب على بياناتك وهدفك، وقِمّة بتجهّز خطتك تلقائيًا. تقدر تعدّل أي شي لاحقًا.',
  bodyGoalLabel: 'هدفك',
  bodyGender: 'الجنس',
  bodyAge: 'العمر',
  bodyAgeHint: 'سنة (12–90)',
  bodyHeight: 'الطول',
  ...
  bodyErrorHint: 'صحّح القيم المظلّلة بالأحمر للمتابعة.',
  bodyCalcIntro: 'قِمّة بتحسب أهدافك من هذه البيانات:',
  ...
  genIntro: 'قِمّة حسبت هذه الأهداف بناءً على بياناتك وهدفك. تقدر تعديلها لاحقًا من الإعدادات المتقدمة.',
  ...
  genTrackNutrition: 'أريد متابعة الأكل',
  ...
  smartDescription: 'قِمّة قدّرت لك الأرقام من بياناتك. عدّل أي رقم يدويًا إذا تبي.',
  smartDisclaimer: 'هذه الحسابات تقديرية للتنظيم والمتابعة فقط، وليست بديلًا عن مختص.',
  smartManualNotice: 'لديك تعديلات يدوية على الحسابات. تقدر إعادة الحساب من بياناتك في أي وقت.',
  ...
  smartWeeksToGoal: 'أسابيع تقديرية للهدف',
  ...
  wtDescription: 'اختر قالبًا جاهزًا ثم عدّله كما تحب — أضف من المكتبة أو احذف.',
  wtReplaceNotice: 'سيتم استبدال جدول التمرين الحالي. تقدر تعدل كل شيء بعد الاختيار.',
  wtCancel: 'إلغاء',
  wtConfirm: 'تأكيد',
  wtDayNameArPlaceholder: 'اسم اليوم (عربي)',
  wtDayNameEnPlaceholder: 'Day name (English)',
  wtWatchGuide: 'شاهد الشرح',
  wtMoveUp: 'أعلى',
  wtMoveDown: 'أسفل',
  wtDelete: 'حذف',
  wtSets: 'مجموعات',
  ...
  wtVideoPlaceholder: 'اتركه فارغًا لاستخدام شرح المكتبة',
  ...
  nutTrackNutrition: 'أريد متابعة الأكل',
  nutDiffersNotice: 'توجد اختلافات بين حساباتك وخطة الأكل.',
  ...
  nutDisclaimer: 'القيم الغذائية تقديرية وقد تختلف حسب المنتج وطريقة التحضير.',

  wellTitle: 'المكملات والأدوية',
  wellDescription: 'نظّم مكملاتك وأدويتك للمتابعة فقط. الأدوية للمتابعة وليست نصيحة طبية.',
  ...
  secTitle: 'الأقسام التي تريدها في صفحتك',
  secDescription: 'اختر الأقسام اللي تبي تشوفها. تقدر تشغّل أو تطفّي أي قسم لاحقًا.',
  secToday: 'اليوم',
  ...
  secAlwaysVisible: 'الملف الشخصي والهدف يظلّون ظاهرين دائمًا.',

  reviewTitle: 'المراجعة والحفظ',
  reviewDescription: 'راجع صفحتك بسرعة، وإذا كل شي تمام احفظ وأقفل. كل شيء محفوظ على جهازك.',
  reviewName: 'اسمك',
  reviewGoal: 'الهدف',
  reviewWeight: 'الوزن',
  ...
  reviewEditLater: 'تقدر ترجع تعدّل أي شي لاحقًا — ما يحتاج معرفة تقنية.',
  reviewAdvancedOptions: 'خيارات متقدمة',
  reviewAdvancedIntro:
    'تقدر تحفظ نسخة احتياطية من صفحتك على جهازك، أو تستعيدها لاحقًا، أو ترجع للإعداد الأساسي.',
  ...
  reviewFullResetNote: 'يحذف بيانات قِمّة فقط من هذا المتصفح، ثم يبدأ من جديد.',

  basicsTitle: 'بياناتي الأساسية',
  basicsDescription: 'نبدأ بأسمك وشكل التعريف بصفحتك. كل هذا تقدر تغيّره لاحقًا.',
  ...
  metricsDescription: 'الأرقام اللي تبي تتابعها — وزنك، نسبة دهونك، محيطاتك. تساعدك تشوف تقدّمك.',
  ...
  suppStepDescription: 'سجّل وش تاخذ، الجرعة، ووقتها — عشان تتابعها بدون ما تنسى.',
  suppSafetyNote:
