...
// [CTO-67] البند ٣ — تلميحات الحدود تُقرأ من مصدر الحقيقة الواحد ولا تُكتب أرقامًا
// صلبة: الرقم المعروض للمستخدم هو الرقم الذي يرفض عنده المدقّق، بلا وسيط.
import {
  AGE_HINT,
  HEIGHT_HINT,
...
const ar: OnboardingStrings = {
  ...
  bodyGender: 'الجنس',
  bodyAge: 'العمر',
  bodyAgeHint: AGE_HINT.ar,
  bodyHeight: 'الطول',
  bodyHeightHint: HEIGHT_HINT.ar,
  bodyWeight: 'الوزن الحالي',
  bodyWeightHint: WEIGHT_HINT.ar,
  bodyTargetWeight: 'الوزن الهدف',
  bodyTargetWeightHint: TARGET_WEIGHT_HINT.ar,
  bodyActivityLevel: 'مستوى النشاط',
  bodyTrainingLevel: 'مستوى التمرين',
  bodyTrainingDays: 'أيام التمرين بالأسبوع',
  bodyTrainingDaysHint: TRAINING_DAYS_HINT.ar,
  bodyWorkoutDuration: 'مدة التمرين',
  bodyWorkoutDurationHint: SESSION_DURATION_HINT.ar,
  ...
  genIntro: 'قِمّة قدّرت هذي الأهداف من بياناتك — تتحسّن مع تسجيلك، وتقدر تعدّلها بعدين.',
...
const en: OnboardingStrings = {
  ...
  bodyGender: 'Gender',
  bodyAge: 'Age',
  bodyAgeHint: AGE_HINT.en,
  bodyHeight: 'Height',
  bodyHeightHint: HEIGHT_HINT.en,
  bodyWeight: 'Current weight',
  bodyWeightHint: WEIGHT_HINT.en,
  bodyTargetWeight: 'Target weight',
  bodyTargetWeightHint: TARGET_WEIGHT_HINT.en,
  bodyActivityLevel: 'Activity level',
  bodyTrainingLevel: 'Training level',
  bodyTrainingDays: 'Training days per week',
  bodyTrainingDaysHint: TRAINING_DAYS_HINT.en,
  bodyWorkoutDuration: 'Workout duration',
  bodyWorkoutDurationHint: SESSION_DURATION_HINT.en,
