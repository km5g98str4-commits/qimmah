...
const ar: OnboardingStrings = {
  ...
  targetWeightTitle: 'ما وزنك المستهدف؟',
  ...
  splitModeTitle: 'كيف تريد أن نحدد التقسيمة؟',
  ...
  nutritionStyleTitle: 'كيف تريد التعامل مع التغذية؟',
  ...
  welcomeDescription:
    'سنجهّز تطبيقك الشخصي خطوة بخطوة. أجب عن أسئلة بسيطة، ويمكنك العودة لتعديل أي شيء وقتما تريد.',
  ...
  smartDescription: 'قدّرت قِمّة أرقامك من بياناتك. عدّل أي رقم يدويًا إن أردت.',
  ...
  wtBalanceFallback: 'راجع توازن جدولك قبل حفظ التغييرات.',
  wtCancel: 'إلغاء',
  wtConfirm: 'تأكيد',
  ...
  secDescription: 'اختر الأقسام التي تريد رؤيتها. يمكنك تشغيل أي قسم أو إيقافه لاحقًا.',
  secToday: 'اليوم',
