...
const ar: LibraryStrings = {
  ...
  noResults: 'لا توجد نتائج مطابقة — جرّب كلمة أو مرشّحًا مختلفًا.',
  ...
  historyEmpty: 'لا يوجد سجلّ لهذا التمرين بعد. سجّل تمرينك وسيظهر هنا.',
  lastWeight: 'آخر وزن',
  bestWeight: 'أفضل وزن',
  ...
  pickerNoResults: 'لا توجد نتائج مطابقة.',
  add: 'أضف',
