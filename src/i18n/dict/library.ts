...
const ar: LibraryStrings = {
  ...
  bestOneRepMax: 'أعلى 1RM تقريبي',
  bestVolume: 'أفضل حجم',
  sessionsCount: 'عدد الجلسات',
  topSetWeightTrend: 'تطوّر وزن أعلى مجموعة',
  needTwoSessions: 'تحتاج جلستين على الأقل عشان يظهر رسم التطوّر.',
  recordsEmpty: 'لسا ما فيه أرقام قياسية — كل جلسة تقرّبك من رقم جديد.',
  recBestWeight: 'أفضل وزن',
  recBestReps: 'أعلى تكرارات',
  recBestVolume: 'أفضل حجم (وزن×تكرار)',
  recBestOneRepMax: 'أعلى 1RM تقريبي',
...
const en: LibraryStrings = {
  ...
  volumeLabel: 'Volume',
  kg: 'kg',
  chartsEmpty: "Once you log workouts, you'll see weight and volume progress and your estimated 1RM here.",
  bestOneRepMax: 'Best est. 1RM',
  bestVolume: 'Best volume',
  sessionsCount: 'Sessions',
  topSetWeightTrend: 'Top set weight trend',
  needTwoSessions: 'You need at least two sessions to see the progress chart.',
