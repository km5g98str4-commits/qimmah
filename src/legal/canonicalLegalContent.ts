...
function privacy(lang: Lang): LegalDocument {
  ...
  if (lang === 'en') return {
    ...
    sections: [
      ...
      { heading: '4. Users aged 12–17', paragraphs: ['The minimum supported age is 12. For users under 18, Qimmah does not calculate or display numeric calorie, macro, or hydration prescriptions, adult BMI interpretation, or weight-change forecasts. Food logging, training, progress, and qualitative guidance remain available. This version does not provide a parental-consent flow.'] },
  ...
  return {
    ...
    sections: [
      ...
      { heading: '٤. الأعمار من 12 إلى 17', paragraphs: ['الحد الأدنى المدعوم 12 سنة. لمن هم دون 18، لا يحسب قِمّة ولا يعرض أهداف سعرات أو ماكروز أو ماء رقمية، ولا تفسير BMI للبالغين، ولا توقع تغيّر وزن. يبقى تسجيل الطعام والتمرين والتقدّم والإرشاد النوعي متاحًا. لا يوجد في هذه النسخة مسار موافقة ولي أمر.'] },
...
function terms(lang: Lang): LegalDocument {
  ...
  if (lang === 'en') return {
    ...
    sections: [
      ...
      { heading: '3. Under-18 product policy', paragraphs: ['For users aged 12–17, Qimmah provides training, logging, progress, and qualitative guidance without adult-derived numeric calorie, macro, hydration, BMI-interpretation, deficit, surplus, or weight-change prescriptions.'] },
  ...
  return {
    ...
    sections: [
      ...
      { heading: '٣. سياسة من هم دون 18', paragraphs: ['لمن أعمارهم من 12 إلى 17، يقدّم قِمّة التمرين والتسجيل والتقدّم والإرشاد النوعي بدون أهداف رقمية مشتقة من معادلات البالغين للسعرات أو الماكروز أو الماء أو تفسير BMI أو العجز والفائض أو توقع تغيّر الوزن.'] },
