 ...
 *
 * **القيم المعتمدة هي حدود الإعداد** (١٣–١٠٠ · ١٢٠–٢٢٠ · ٣٠–٢٥٠): هي الأضيق،
 ...
 * المقفل (١٣ فما فوق) — فالتوحيد نزل إلى الأضيق لا إلى الأوسع.
 *
 * **حدّ العمر ١٣ قرار مؤسس مقفل** (QIMMAH-QUALITY-CHARTER §٣-١) — يُقرأ من هنا
 ...
 */
export const AGE_RANGE: NumericRange = { min: 13, max: 100 } as const
