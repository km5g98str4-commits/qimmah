 ...
 *
 * **حدّ العمر ١٢ قرار مؤسس مقفل** (FOUNDER AUTHORIZATION — AGE 12 SUCCESSOR RC) — يُقرأ
 * من هنا ولا يُعاد إعلانه في أي ملف. وهو **غير** حدّ الأمان دون ١٨: الأوّل أهلية
 * تسجيل، والثاني حجب الوصفة الرقمية للبالغين (`ADULT_MIN_AGE` في `lib/calculators.ts`).
 */
