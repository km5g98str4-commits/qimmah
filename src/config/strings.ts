...
const ar: ShellStrings = {
  ...
  auth: {
    ...
    disabledBody: 'المزامنة السحابية غير مفعّلة في هذه النسخة. تواصل مع مزوّد الخدمة لتفعيل الحساب.',
    guestBadge: 'ضيف',
    guestNote: 'بيانات الضيف محفوظة على هذا الجهاز فقط.',
  ...
  workout: {
    ...
    confirmUnfinished: 'ما زالت هناك تمارين لم تكملها. هل تريد إنهاء التمرين؟',
    ...
    noPrs: 'لا رقم قياسي هذه المرة — كل جولة تقرّبك.',
    musclesTrained: 'عضلات مرّنتها',
    nextWorkout: 'تمرينك القادم',
    backToToday: 'العودة لليوم',
    viewProgress: 'عرض تقدمي',
    reminderCtaText: 'هل تريد تذكيرًا بموعد تمرينك القادم؟',
    reminderCtaButton: 'ذكّرني بموعد تمريني',
    reminderCtaEnabled: 'تذكير التمرين مفعّل — سيصلك في الوقت المحدد.',
  ...
  commit: {
    title: 'التزاماتي',
    desc: 'الأشياء التي تريد الالتزام بها يوميًا أو أسبوعيًا.',
    enable: 'أريد متابعة الالتزامات اليومية',
    intro: 'اختر الأشياء التي تريد الالتزام بها يوميًا أو أسبوعيًا. يمكنك تعديلها لاحقًا.',
    add: 'أضف من المكتبة',
  ...
  progress: {
    ...
    selectTypes: 'اختر القياسات التي تريد متابعتها',
...
const en: ShellStrings = {
  ...
  auth: {
    ...
    disabledBody: 'Cloud sync is not enabled in this build. Contact the provider to enable accounts.',
    guestBadge: 'Guest',
    guestNote: 'Guest data is stored on this device only.',
