...
export const hero = {
  eyebrow: 'خطتك الشخصية للنادي',
  titleTop: 'خطتك الشخصية للنادي',
  titleHighlight: 'في صفحة واحدة',
  description:
    'صفحة ويب شخصية تجمع هدفك، جدولك الأسبوعي، تمارينك، أكلك، مكملاتك، وتعليماتك المهمة — مبنية على حالتك، وتفتحها من جوالك بأي وقت.',
...
export const finalCta = {
  ...
  description: 'كل ما تحتاجه في صفحة واحدة مبنية على حالتك، تفتحها من جوالك في أي وقت.',
  primary: 'افتح خطتي',
