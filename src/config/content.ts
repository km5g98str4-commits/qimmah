// كل نصوص أقسام العرض في مكان واحد.
...
export const sectionCopy: Record<string, SectionCopy> = {
  ...
  customization: {
    eyebrow: 'خصّص قِمّة',
    icon: 'Sparkles',
    title: 'خلّ التطبيق على ذوقك',
    description: 'غيّر اسمك، هدفك، وألوانك — وتنعكس مباشرة على خطتك.',
  },

  // مفاتيح أقسام إضافية غير معروضة حاليًا
  metrics: {
    eyebrow: 'قياساتك',
    icon: 'Ruler',
...
export const customizationPoints: string[] = [
  'كل بياناتك تتعدّل من مكان واحد',
  'عربية بالكامل وتُقرأ من اليمين لليسار',
  'مريحة على الجوال — تفتحها بأي وقت',
  'ألوان وهوية تغيّرها بنفسك',
]
export const customizationSwatchLabel = 'اختر لونك'

// تنبيه صحي بسيط
export const healthNotice = {
  title: 'تنبيه صحي بسيط',
  body: 'قِمّة لتنظيم خطتك الشخصية فقط، وليست بديلًا عن استشارة طبية. قبل تغيير تمارينك أو أكلك أو أي دواء أو مكمّل، راجع مختصًّا — خصوصًا إن كانت لديك حالة صحية.',
}

// CTA ختامي (غير معروض حاليًا)
