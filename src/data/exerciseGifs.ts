...
export const exerciseGifs: Record<string, string> = {
  ...
  'dumbbell-kickback': '/exercise-gifs/dumbbell-kickback.gif',
  ...
  'dumbbell-sumo-squat': '/exercise-gifs/dumbbell-sumo-squat.gif',
  ...
  'single-arm-cable-row': '/exercise-gifs/single-arm-cable-row.gif',
