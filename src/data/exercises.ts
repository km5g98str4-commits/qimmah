...
const muscleDetailById: Record<string, MuscleDetail> = {
  ...
  'pendulum-squat-machine': { primary: ['quads'], secondary: ['glutes'] },
...
export const exercises: Exercise[] = [
  ...
  ex({ id: 'cable-crunch', nameAr: 'طحن بالكيبل', nameEn: 'Cable Crunch', primaryMuscle: 'core', equipment: ['cable'], level: 'beginner', movementPattern: 'core', environment: 'gym', defaultReps: '12–15', defaultRestSec: 45, alternatives: ['crunch', 'cable-woodchop'] }),
  ...
  // ===== الكوادز (إضافات) =====
  ex({ id: 'pendulum-squat-machine', nameAr: 'سكوات البندول', nameEn: 'Pendulum Squat Machine', primaryMuscle: 'quads', secondaryMuscles: ['glutes'], equipment: ['machine'], level: 'beginner', movementPattern: 'squat', environment: 'gym', defaultReps: '8–12', defaultRestSec: 120, alternatives: ['goblet-squat', 'bodyweight-squat'] }),
  ...
  ex({ id: 'ab-crunch-machine', nameAr: 'جهاز طحن البطن', nameEn: 'Ab Crunch Machine', primaryMuscle: 'core', equipment: ['machine'], level: 'beginner', movementPattern: 'core', environment: 'gym', defaultReps: '12–20', defaultRestSec: 45, alternatives: ['crunch', 'cable-crunch'] }),
