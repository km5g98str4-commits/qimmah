// 40 educational micro-lessons (warm MSA, 60–100 words each, one takeaway each).
...
export const LESSONS: Lesson[] = [
  // ── التحميل التدريجي (progressive overload) ──
  {
    ...
    takeawayAr: 'دوّن وزنك وتكراراتك اليوم لتعرف من أين تزيد في الجلسة القادمة.',
  },
  {
    ...
    takeawayAr: 'إذا أتقنت كل جولاتك بأداء نظيف، ارفع الوزن أدنى زيادة متاحة فقط.',
  },
  {
    ...
    takeawayAr: 'اختر نطاق تكرارات ثابتًا لكل تمرين، وتسلّق داخله قبل زيادة الوزن.',
  },
  {
    id: 'overload-track',
    topic: 'overload',
    titleAr: 'ما لا يُقاس لا يتقدّم',
    bodyAr:
  ...
  },
  {
    ...
    topic: 'overload',
    titleAr: 'التقدّم ليس خطًّا مستقيمًا',
    bodyAr:
    ...
    takeawayAr: 'احكم على تقدّمك كل أربعة إلى ستة أسابيع، لا من جلسة إلى جلسة.',
  },
  ...
  // ── الراحة بين الجولات (rest) ──
  {
    id: 'rest-why',
    topic: 'rest',
    titleAr: 'لماذا الراحة بين الجولات؟',
    bodyAr:
    ...
    takeawayAr: 'انتظر حتى يهدأ تنفّسك وتشعر بجاهزية قبل بدء الجولة التالية.',
  },
  {
    id: 'rest-heavy',
    topic: 'rest',
    ...
    takeawayAr: 'خصّص راحة أطول للتمارين المركّبة الثقيلة مقارنةً بتمارين العزل.',
  },
  {
    ...
    takeawayAr: 'قلّل راحتك قليلًا على تمارين العزل ما دام أداؤك يبقى نظيفًا.',
  },
  {
    id: 'rest-consistency',
    topic: 'rest',
    titleAr: 'ثبّت راحتك لتقارن بعدل',
    bodyAr:
    ...
    takeawayAr: 'استخدم مؤقّت الراحة في التطبيق لتثبيت زمنك بين الجولات.',
  },
  {
    id: 'rest-active',
    topic: 'rest',
    titleAr: 'ماذا تفعل أثناء الراحة؟',
    bodyAr:
    ...
    takeawayAr: 'تنفّس بعمق واحتسِ رشفة ماء بدل الانشغال بالهاتف أثناء الراحة.',
  },
  ...
  // ── توقيت البروتين (protein timing) ──
  {
    ...
    takeawayAr: 'ركّز أولًا على بلوغ مجموع البروتين اليومي قبل القلق حول توقيته.',
  },
  {
    id: 'protein-spread',
    topic: 'protein',
    ...
    takeawayAr: 'أضف مصدر بروتين واضحًا إلى كل وجبة رئيسية في يومك.',
  },
  {
    ...
    takeawayAr: 'خطّط لوجبة فيها بروتين ضمن الساعات المحيطة بتمرينك.',
  },
  {
    id: 'protein-sources',
    topic: 'protein',
    ...
    takeawayAr: 'اجعل الطعام الحقيقي أساس بروتينك، والمكمّل مجرّد وسيلة عند الحاجة.',
  },
  {
    id: 'protein-satiety',
    topic: 'protein',
    ...
    takeawayAr: 'ابدأ وجباتك بمصدر البروتين لتشعر بشبع أطول بين الوجبات.',
  },
  ...
  // ── النوم (sleep) ──
  {
    ...
    takeawayAr: 'تعامل مع نومك كجزء من برنامجك، لا كوقت فائض تقتطع منه.',
  },
  {
    ...
    takeawayAr: 'ثبّت موعد نومك واستيقاظك ضمن نطاق متقارب كل يوم.',
  },
  {
    id: 'sleep-environment',
    topic: 'sleep',
    titleAr: 'هيّئ بيئة نومك',
    bodyAr:
    ...
    takeawayAr: 'خفّض الأضواء وأبعد الشاشة قبل نومك بنصف ساعة على الأقل.',
  },
  {
    ...
    takeawayAr: 'بعد ليلة نوم قليلة، اضبط توقّعك واحرص على الأداء الآمن النظيف.',
  },
  {
    id: 'sleep-naps',
    topic: 'sleep',
    titleAr: 'القيلولة القصيرة قد تساعد',
    bodyAr:
    ...
    takeawayAr: 'اجعل قيلولتك قصيرة ومبكرة بعد الظهر حتى لا تؤثّر في نوم ليلك.',
  },
  ...
  // ── الثبات وكسر الركود (plateaus) ──
  {
    ...
    takeawayAr: 'قبل تغيير برنامجك، راجع نومك وغذاءك وانتظامك ودقّة تسجيلك.',
  },
  {
    id: 'plateau-one-change',
    topic: 'plateau',
    titleAr: 'غيّر متغيّرًا واحدًا',
    bodyAr:
    ...
    takeawayAr: 'عدّل عاملًا واحدًا فقط، وامنحه أسبوعين إلى ثلاثة قبل الحكم.',
  },
  {
    id: 'plateau-technique',
    topic: 'plateau',
    titleAr: 'حسّن الأداء أولًا',
    bodyAr:
    ...
    takeawayAr: 'راجع أداءك بمدى كامل وتحكّم قبل أن تلوم البرنامج على الثبات.',
  },
  {
    id: 'plateau-recovery',
    topic: 'plateau',
    titleAr: 'قد يكون الحلّ راحة لا مجهودًا',
    bodyAr:
    ...
    takeawayAr: 'إن رافق الثبات تعب وفتور دائم، خفّف حملك وحسّن تعافيك أسبوعًا.',
  },
  {
    ...
    takeawayAr: 'قِس تقدّمك على مدى أشهر، وتوقّع مكاسب أصغر كلّما تقدّمت خبرتك.',
  },
  ...
  // ── التخفيف المبرمج (deloads) ──
  {
    ...
    takeawayAr: 'اعتبر التخفيف جزءًا مخطّطًا من برنامجك، لا انقطاعًا عنه.',
  },
  {
    id: 'deload-when',
    topic: 'deload',
    titleAr: 'متى تحتاج تخفيفًا؟',
    bodyAr:
    ...
    takeawayAr: 'إذا اجتمع تعب دائم وفتور وأوزان أثقل من المعتاد، خطّط لتخفيف.',
  },
  {
    id: 'deload-how',
    topic: 'deload',
    ...
    takeawayAr: 'في أسبوع التخفيف، قلّل الجولات أو الوزن وأبقِ حركتك خفيفة ونظيفة.',
  },
  {
    id: 'deload-mindset',
    topic: 'deload',
    titleAr: 'التخفيف ليس تراجعًا',
    bodyAr:
    ...
    takeawayAr: 'ذكّر نفسك أن أيام التخفيف القليلة تعيد جاهزيتك ولا تمحو تقدّمك.',
  },
  {
    id: 'deload-return',
    topic: 'deload',
    titleAr: 'العودة بعد التخفيف',
    bodyAr:
    ...
    takeawayAr: 'ارجع بعد التخفيف بحمل مريح، وتدرّج قبل ملاحقة أرقام جديدة.',
  },
  ...
  // ── الترطيب (hydration) ──
  {
    ...
    takeawayAr: 'وزّع شرب الماء على يومك بدل تركه إلى جرعة واحدة كبيرة.',
  },
  {
    ...
    takeawayAr: 'احمل زجاجة ماء وخذ رشفات بين الجولات، خصوصًا في الحرّ.',
  },
  {
    id: 'hydration-signs',
    topic: 'hydration',
    ...
    takeawayAr: 'انتبه للعطش وجفاف الفم ولون البول الغامق كإشارات لشرب الماء.',
  },
  {
    id: 'hydration-habit',
    topic: 'hydration',
    titleAr: 'اجعل الشرب عادة',
    bodyAr:
    ...
    takeawayAr: 'اربط شرب الماء بعادة ثابتة: كوب عند الاستيقاظ ومع كل وجبة.',
  },
  {
    id: 'hydration-balance',
    topic: 'hydration',
    titleAr: 'الاعتدال في كل شيء',
    bodyAr:
    ...
    takeawayAr: 'وزّع ماءك باعتدال حسب نشاطك وحرارة جوّك، لا دفعة واحدة.',
  },
  ...
  // ── الألم مقابل الشدّ (soreness vs pain) ──
  {
    ...
    takeawayAr: 'تعامل مع الشدّ العضلي الخفيف كتأقلم طبيعي، لا كمقياس لنجاح تمرينك.',
  },
  {
    id: 'soreness-vs-pain',
    topic: 'soreness',
    ...
    takeawayAr: 'توقّف عن أي ألم حادّ أو مفصلي، واستشر مختصًا إذا استمرّ أو زاد.',
  },
  {
    id: 'soreness-manage',
    topic: 'soreness',
  ...
  },
  {
    ...
    takeawayAr: 'احكم على تمرينك بأرقامك وتقدّمك المسجّل، لا بمقدار الشدّ بعده.',
  },
  {
    id: 'soreness-when-consult',
    topic: 'soreness',
    titleAr: 'متى تستشير مختصًا؟',
    bodyAr:
    ...
    takeawayAr: 'راجع مختصًا عند ألم مستمرّ أو حادّ أو متورّم أو متكرّر في المكان نفسه.',
  },
]
