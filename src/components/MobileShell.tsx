...
/** قشرة التطبيق على الجوال — المحتوى يملك ترويسة سياقه + شريط تنقّل سفلي ثابت. */
export function MobileShell({ lang, tab, onNavigate, onOpenSettings, children }: MobileShellProps) {
  const ar = lang !== 'en'
