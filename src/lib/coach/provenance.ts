...
//
// مدقّق إسناد بلا مُنتِج لـ`CoachAnswer` وبلا مُشغِّل في البوابة — أي أن
// «حارس المدرّب ذا الستّة عشر فحصًا» المذكور في تقارير سابقة **لا يُشغَّل**.
// انظر رأس `src/lib/coach/types.ts`، ولا تخلطها بـ`src/lib/coaching/` الحيّة.
