...
//
// طبقة «المدرّب» منطقٌ **بلا واجهة وبلا مسار وبلا مستهلك**: لا شيء في `src/`
// يستورد `@/lib/coach`. ولا تخلطها بـ`src/lib/coaching/` — تلك **حيّة**
// (نصائح ودروس تُعرض فعلًا)، والتشابه في الاسم هو الفخّ.
//
// ويحرس هذا الإعلانَ `test:canonical-surface`. الحالة في
// `docs/execution/qimmah-master/04-FEATURE-MAP.md` (F-GAP-11)، والقرار DEC-105.
