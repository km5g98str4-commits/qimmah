...
export interface PrMetric extends MetricBase { key: 'pr'; exerciseName: string | null; nearestPct: number | null }
...
export interface InsightInput {
  ...
  sessions: { date: string; volume: number; muscleGroups: string[]; topSets: { exerciseId: string; name: string; weightKg: number }[] }[]
  plan: { daysPerWeek: number; targetProtein: number | null; muscleGroups: string[] }
  ...
  prBests: Record<string, { name: string; best: number }>
}
