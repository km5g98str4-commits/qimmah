...
export const DATA_KEYS: readonly DataKeyDef[] = [
  ...
  { key: 'qimmah:customization:v1', kind: 'user', scoped: false, exported: true, synced: false, owner: 'customization', migration: 'owner-suffix', note: 'أهداف/خطة — ترشيح مزامنة لاحقًا' },
