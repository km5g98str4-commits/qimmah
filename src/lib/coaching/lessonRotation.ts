 ...
 */
export function selectNextLesson(shown: readonly string[], seed: number): { lesson: Lesson; shown: string[] } {
  ...
  return { lesson, shown: [...base, lesson.id] }
}
...
export function currentTodayLesson(userId: string | null | undefined, seed: number): Lesson {
  return selectNextLesson(readShown(userId), seed).lesson
}
