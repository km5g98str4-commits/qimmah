 ...
 * المطابقة** لا لغتها.
 */
// [FOOD-GENERIC-001] الدرجة ٣ (كلمة مفتاحية = الاستعلام) ٥٫٦: فوق بادئة اسم معبّأ
// (٥٫٧٥) ودون اسمه التامّ (٥٫٥) — «مكسرات» تعطي اللوز قبل «مكسرات يابانية»،
// و«بيبسي» تبقى لمنتج اسمه Pepsi بعينه. مقيس في test:food-coverage.
// [FOOD-GENERIC-001] الدرجة ١ (كلمة = الاستعلام على صنف عامّ) ٢: قبل بادئة اسم منسَّق (٣)
// وقبل اسم معبّأ تامّ (٥٫٥) — «توست» يعطي خبز التوست قبل أي منتج، والباركود التامّ (٠) يبقى أعلى.
const CURATED_STRENGTH = [1, 2, 3, 5, 5.6, 7, 9, 10] as const
