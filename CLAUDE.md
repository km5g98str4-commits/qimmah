...
## قواعد سير العمل (ملزمة)
- **الدمج في `main` لا يحدث إلا بكلمة «approved» صريحة من زياد.** لا استثناءات ولا استنتاج: وصول brief جديد، أو نجاح QA، أو أي إشارة ضمنية أخرى ≠ موافقة. عند أي غموض توقّف واسأل.
- **brief مفقود → توقّف واسأل. لا تخترع نطاق مرحلة أبدًا.**
