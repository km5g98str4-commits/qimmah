...
>
> تاريخ البناء: `2026-08-14T12:40:41.587Z` · نسخة التطبيع: `1.1.0` · نسخة المخطّط: `1.0.0`
...
| عالمي (GLOBAL) | 55,000 |
| مكرّرات أُزيلت | 0 |
| تعارضات مرفوعة (لم تُدمج) | 3,019 |
| طابور مراجعة ضبابي | 5,160 |

> ⚠️ **إفصاح:** تصدير OFF كان **ناقصًا** وقت هذا البناء — نُزّل 787.06 ميغابايت
> من أصل 1216.10 (64.7%). والتصدير **مرتّب بالباركود**، وبادئة
...
قياسًا على الطقم الساخن (السعودية والخليج حصرًا، 600 سجلًا):

| المصدر | سجلات | منها باسم عربي |
|---|---|---|
| `qimmah_curated` (PKG-001) | 55 | **55** |
| `openfoodfacts` | 545 | **6** |

مساهمو Open Food Facts في الخليج **يكتبون بالإنجليزية تقريبًا دائمًا**. فبيانات قِمّة
المنسَّقة — رغم صغرها — تقدّم **90.2٪ من كل الأسماء العربية**
...
| فهارس البحث مضغوطة | 2.18 ميغابايت |
| **الإجمالي المضغوط** | **15.63 ميغابايت** |
| الطقم الساخن | 600 سجلًا · 108 ك.ب مضغوط · ميزانية 120 ك.ب · **ضمنها** |
