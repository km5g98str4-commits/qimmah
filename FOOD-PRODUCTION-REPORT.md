...
| عالمي (GLOBAL) | 55,000 |
| مكرّرات أُزيلت | 23 |
| تعارضات مرفوعة (لم تُدمج) | 2,014 |
| طابور مراجعة ضبابي | 5,097 |
...
|---|---|---|
| اسم عربي | 358 | 0.6% |
| اسم إنجليزي | 59,639 | 99.5% |
| ماكروز كاملة (بروتين+كارب+دهن) | 59,728 | 99.6% |
| صوديوم | 57,508 | 95.9% |
| ألياف | 49,072 | 81.9% |
| حجم حصّة | 35,428 | 59.1% |
| مكوّنات | 53,464 | 89.2% |

### توزيع الثقة

- `high_0.8+` — 48,538 (81.0%)
- `mid_0.6-0.8` — 8,750 (14.6%)
- `low_0.4-0.6` — 1,945 (3.2%)
- `very_low_<0.4` — 708 (1.2%)

### أعلام الجودة (وسم لا رفض)

| العلم | العدد | النسبة |
|---|---|---|
| `no_arabic_name` | 59,583 | 99.4% |
| `no_brand` | 2,445 | 4.1% |
| `fiber_exceeds_carbs` | 1,495 | 2.5% |
| `macro_energy_mismatch` | 1,492 | 2.5% |
| `no_english_name` | 302 | 0.5% |
| `sugar_exceeds_carbs` | 92 | 0.2% |
| `saturated_exceeds_fat` | 37 | 0.1% |
| `serving_size_implausible` | 4 | 0.0% |
...
|---|---|
| عدد الشرائح | 41 |
| أصغر شريحة (مضغوطة) | 309 كيلوبايت |
| الوسيط | 325 كيلوبايت |
| أكبر شريحة | 343 كيلوبايت |
| **ضمن الميزانية (٢٠٠–٥٠٠ ك.ب)** | **41/41** |
| بيانات مضغوطة | 12.97 ميغابايت |
| بيانات خام | 70.67 ميغابايت |
| فهارس البحث مضغوطة | 2.57 ميغابايت |
| **الإجمالي المضغوط** | **15.55 ميغابايت** |
...
- **الشرائح لا تُلتزم في git** (70.67 ميغابايت): تُولَّد حتميًا وبصمة كلٍّ منها
